...
/* ── Obtener usuarios ── */
$stmt      = $pdo->query("SELECT id_usuario, nombre, apellido_paterno, apellido_materno, correo, activo FROM usuarios ORDER BY id_usuario");
...
<div class="modal-overlay" id="modalUsuario">
    <div class="modal-box">
        ...
        <form method="POST" action="index.php?menu=usuarios&opc=tabla" onsubmit="return validarFormulario(this)">
    ...
    <div class="modal-box">
        ...
        <form method="POST" action="index.php?menu=usuarios&opc=tabla"
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    <label>Correo electrónico</label>
                    <input type="email" name="correo" id="edit_correo" placeholder="correo@ejemplo.com" required>
                </div>
